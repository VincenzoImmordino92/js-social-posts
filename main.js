...
posts.forEach((postSingolo) =>{
    ...
    <div class="post-meta">  
        ...
        <div class="post-meta__icon">
            ...
            <img class="profile-pic" src="${postSingolo.author.image}" alt="${postSingolo.author.name}">                    
        </div>

        <div class="post-meta__data">

            <div class="post-meta__author">${postSingolo.author.name}</div>
...
<div class="post__text">${postSingolo.content}</div>
<div class="post__image">
    <img src="${postSingolo.media}" alt="">
</div>
